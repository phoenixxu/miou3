...
public class HttpTask extends MeasurementTask {
  ...
  public MeasurementResult call() throws MeasurementError {
    ...
    try {
      ...
      httpClient.getParams().setParameter(CoreConnectionPNames.CONNECTION_TIMEOUT, task.timeout);
      httpClient.getParams().setParameter(CoreConnectionPNames.SO_TIMEOUT, task.timeout);
