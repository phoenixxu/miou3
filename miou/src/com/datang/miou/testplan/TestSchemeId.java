...
public abstract class TestSchemeId {
     ...
     * 发送彩信 0x060A<br>
     * 接收彩信 0x060B<br>
     * FTP上传/下载测试 0x060C<br>
     * 流媒体测试 0x0611<br>
     * 接收POP3邮件测试 0x0612<br>
     * 发送SMTP邮件测试 0x0613<br>
     */
    public static final String x0500 = "语音主叫";
    public static final String x0501 = "语音被叫";
    public static final String x0502 = "空闲测试";
    public static final String x0602 = "Attach测试";
