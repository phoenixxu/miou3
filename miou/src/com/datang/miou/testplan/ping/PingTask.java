...
import com.datang.miou.testplan.MeasurementTask;
...
public class PingTask extends MeasurementTask {
    ...
    private MeasurementResult constructResult(ArrayList<Double> rrtVals, double packetLoss,
        ...
        PhoneUtils.setGlobalContext(this.parent);
        PhoneUtils.getPhoneUtils().getNetwork();
     ...
     * the wireless interface and resolve domain names. Such distorted com.datang.business.measurements are filtered out
     *
     */
    private double filterPingResults(final ArrayList<Double> rrts, double avg) {
        ...
        try {
            ...
            Log.wtf(TAG, "This should never happen because rrts is never empty");
        }
        return rrtAvg;
    }
