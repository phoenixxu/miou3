package com.datang.miou.testplan;/* Copyright 2012 Google Inc.
 *
...
import com.datang.miou.testplan.http.HttpTask;
import com.datang.miou.testplan.http.HttpTask.HttpDesc;
import com.datang.miou.testplan.ping.PingTask;
import com.datang.miou.testplan.ping.PingTask.PingDesc;
...
public class MeasurementResult {
    ...
    public String toString() {
        ...
        try {
        	...
        	Log.i(TAG, "Exception occurs during constructing result string for user, number fromat exception");
        	e.printStackTrace();
            Logger.e("Exception occurs during constructing result string for user", e);
        } catch (ClassCastException e) {
        	Log.i(TAG, "Exception occurs during constructing result string for user, class cast exception");
        	e.printStackTrace();
            Logger.e("Exception occurs during constructing result string for user", e);
        } catch (Exception e) {
        	Log.i(TAG, "Exception occurs during constructing result string for user, exception");
        	e.printStackTrace();
            Logger.e("Exception occurs during constructing result string for user", e);
        }
