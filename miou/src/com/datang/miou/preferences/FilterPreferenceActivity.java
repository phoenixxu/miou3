...
public class FilterPreferenceActivity extends FragmentActivity implements FragmentSupport.Callbacks{
    ...
    //定义数组来存放Fragment界面  
    private Class<?> fragmentArray[] = {EventFilterFragment.class, SignalFilterFragment.class};  
      
    //Tab选项卡的文字  
    private String mTextviewArray[] = {"事件筛选", "信令筛选"};
    
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		// TODO 自动生成的方法存根
		super.onCreate(savedInstanceState);
		setContentView(R.layout.preference_filter);
		
		mTitleTextView = (TextView) findViewById(R.id.app_title_value);
		mTitleTextView.setText(R.string.pref_filter_title);
