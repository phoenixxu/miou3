...
public class GenParamsLteFragment extends FragmentSupport {
	...
	void init() {
		...
		mServingCellTable = TableManager.createTable(getActivity(), servingCellInfoTable, Globals.TABLE_SERVICE_CELL_LTE);
		
		LinearLayout neighborCellInfoTable = (LinearLayout) mView.findViewById(R.id.neighbor_cell_info_table);
		
		mNeighborCellTable = TableManager.createTable(getActivity(), neighborCellInfoTable, Globals.TABLE_NEIGHBOR_CELL_LTE);
