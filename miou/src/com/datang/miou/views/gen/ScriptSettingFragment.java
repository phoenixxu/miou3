...
public class ScriptSettingFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater,
		...
		View view = inflater.inflate(R.layout.script_setting, container, false);
	...
	private void fillSpinner() {
		...
		switch (mTestScriptType) {
			case TEST_SCRIPT_TYPE_DOT:
				arraySource = R.array.test_type_dot;
				break;
			case TEST_SCRIPT_TYPE_TRACE:
				arraySource = R.array.test_type_trace;
				break;
			case TEST_SCRIPT_TYPE_GEN:
				arraySource = R.array.test_type_gen;
				break;
		}
		ArrayAdapter<CharSequence> adapterXml = ArrayAdapter.createFromResource(getActivity(), arraySource, android.R.layout.simple_spinner_item);
