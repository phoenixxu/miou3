...
public class ConnectFragment extends Fragment {
    ...
    private ConnectResultAdapter adapter;
        ...
        this.receiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                if (intent.getAction().equals(UpdateIntent.MEASUREMENT_PROGRESS_UPDATE_ACTION)) {
                    if (intent.getStringExtra(UpdateIntent.TASK_TYPE).equals(PingTask.TYPE)) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ListView resultListView = (ListView) root.findViewById(R.id.ping_result);
        adapter = new ConnectResultAdapter(this.getActivity(), result);
