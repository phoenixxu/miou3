...
public class EditConnectActivity extends ActivitySupport {
    private static final String TAG = "EditConnectActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] webNames = this.getResources().getStringArray(R.array.ping_names);
        ...
        final String[] webURLs = this.getResources().getStringArray(R.array.ping_urls);
