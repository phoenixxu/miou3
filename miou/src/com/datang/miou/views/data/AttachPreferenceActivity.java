...
public class AttachPreferenceActivity extends FragmentActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mTitleTextView.setText(R.string.pref_attach_title);
		...
		for (TestCommand command : mCommands) {
			if (command.getId().equals(Globals.TEST_COMMAND_ATTACH)) {
