...
import com.datang.miou.views.gen.GenParamsFragment.ViewPageChangeListener;
 ...
 * @author suntongwei
 */
@AutoView(R.layout.gen_params)
public class InnerParamsFragment extends FragmentSupport {
	...
	public void updateUI(RealData data) {
		/*
		mmcMncTextView.setText(reserveTwoBit(data.mmc));
		tmTextView.setText(reserveTwoBit(data.tm));
		ulDlFreqTextView.setText(reserveTwoBit(data.freq));
		ulDlBandwidthTextView.setText(reserveTwoBit(data.bandwidth));
		workModeTextView.setText(reserveTwoBit(data.mode));
		bandTextView.setText(reserveTwoBit(data.bandwidth));
		pciTextView.setText(reserveTwoBit(data.pci));
		ecgiTextView.setText(reserveTwoBit(data.ecgi));
		rrcStateTextView.setText(reserveTwoBit(data.rrc));
		emmStateTextView.setText(reserveTwoBit(data.emm));
		*/
	}
