...
/**
 * A repackaged Intent class that includes MIOU-specific information.
 *
...
public class UpdateIntent extends Intent {
    ...
    public static final String STATS_RESULT = "STATS_RESULT";
    ...
    public static final String TASK_LAST_TIME = "TASK_LAST_TIME";
