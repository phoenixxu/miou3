...
public interface Config {
  ...
  // Default interval in seconds between system com.datang.business.measurements of a given measurement type
  public static final double DEFAULT_SYSTEM_MEASUREMENT_INTERVAL_SEC = 15 * 60;
  // Default interval in seconds between user com.datang.business.measurements of a given measurement type
  ...
  /** Constants used in com.datang.business.MeasurementScheduler.java */
