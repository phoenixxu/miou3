...
/**
 * com.datang.business.MeasurementDesc and all its subclasses are POJO classes that encode a measurement
...
public abstract class MeasurementDesc {
    ...
    // General parameters that are shared by all com.datang.business.measurements
    public String type;
    public String key;
     ...
     * @param startTime   Earliest time that com.datang.business.measurements can be taken using this Task descriptor. The
     ...
     * @param endTime     Latest time that com.datang.business.measurements can be taken using this Task descriptor. Tasks
     ...
     * @param intervalSec Minimum number of seconds to elapse between consecutive com.datang.business.measurements taken
     ...
     */
    protected MeasurementDesc(String type, String name, String key, Date startTime,
    ...
    public String toString() {
        return "<com.datang.business.MeasurementTask> " + this.type + " deadline:" + endTime +
                " params:" + parameters;
    }
}
